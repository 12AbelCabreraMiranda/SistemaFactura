...
{
    public partial class my_models : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrecioProductoCompra = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TempProductoId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Cantidad_temp = table.Column<int>(type: "int", nullable: false),
                    PrecioVenta_temp = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ProductoId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TempProducto", x => x.TempProductoId);
                    table.ForeignKey(
                        name: "FK_TempProducto_Producto_ProductoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TempProducto_ProductoId",
                table: "TempProducto",
                column: "ProductoId");
        }
